...
document.getElementById('generateBtn').addEventListener('click', function() {
    window.location.href = '/dessertsresults';
});
// ----------------------------------------------------------
...
document.getElementById('logout').addEventListener('click', function(e) {
    e.preventDefault();
    console.log('Logout button clicked'); // Log to ensure the event is fired
    fetch('/logout', {
        method: 'POST',
        headers: {
    ...
    .then(response => {
        if (response.ok) {
            console.log('Logout successful'); // Log successful response
            window.location.href = '/'; // Redirect to home page or login page
        } else {
            console.error('Logout failed:', response); // Log error response
            alert('Logout failed');
        }
    })
    .catch(error => {
